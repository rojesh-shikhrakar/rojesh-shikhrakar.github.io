...
description: "From automated literature reviews to intelligent meeting summaries—here's how I use AI daily to reclaim three hours every day."
date: '2025-03-15'
...
insights:
  - title: 'Anchor AI to a source'
    body: 'Use documents, transcripts, and trusted data when accuracy matters; reserve free generation for brainstorming.'
  - title: 'Keep judgment in the loop'
    body: 'Every AI-generated output intended for another person should pass through a critical human review.'
  - title: 'Invest in specificity'
    body: 'Well-designed prompts and reusable workflows compound in value across repeated professional tasks.'
---
